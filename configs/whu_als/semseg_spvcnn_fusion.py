...
model = dict(
    ...
    #         ratio=1./16.,
    #     ),
    #     stage_with_gcb=(True, True, True, True)
    #     ),
    criteria=[
        dict(type="CrossEntropyLoss", weight = [1.80522474,  2.24312724,  2.86381332, 15.21661442,1.85515968, 61.89627364],
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                type="Collect",
                keys=("coord", "grid_coord", "segment","name","img","points_img","relative_z"),
                feat_keys=("coord"),
            ),
        ],
        test_mode=False,
    ...
    test=dict(
        ...
        test_cfg=dict(
            ...
            post_transform=[
                ...
                dict(
                    type="Collect",
                    keys=("coord", "grid_coord", "index" ,"segment","name","img","points_img","relative_z"),
                    feat_keys=("coord"),
                ),
            ],
            aug_transform=[
